                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-3 mt-4">
                      ...
                      <button 
                        ...
                        className="px-4 py-2 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 font-black text-[10px] md:text-xs rounded-xl cursor-pointer transition-all border border-indigo-500/10 flex items-center gap-1.5"
                      >
